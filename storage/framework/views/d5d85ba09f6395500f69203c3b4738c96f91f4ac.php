<?php $__env->startSection('title', 'DsignLoft - Creative Brief Flow'); ?>
...
<a class="header-login" href="<?php echo e(url("login")); ?>" id="headerLoginBtn">Login</a>
</div>
</div>
...
<script src="<?php echo e(asset("assets/js/firebase-config.js")); ?>"></script>
...
<script>
    ...
    function proceedToSignup() {
        ...
        window.location.href = `<?php echo e(url("signup")); ?>?email=${encodeURIComponent(appState.briefDetails.email)}&briefId=${briefId}`;
    }
    ...
    async function saveChangesAndReturn(uid) {
        ...
        try {
            const response = await fetch("<?php echo e(url("api/brief/save")); ?>", {
                method: "POST",
    ...
    function proceedToSignup() {
      ...
      window.location.href = `<?php echo e(url("signup")); ?>?email=${encodeURIComponent(email)}`;
    }
      ...
      printWindow.document.write(`
        ...
        <head>
          ...
          <style>
                @font-face {
                  font-family: "Graphik";
                  src: url("<?php echo e(asset("assets/fonts/Graphik Italic.woff")); ?>") format("woff");
                  font-weight: 400;
                  font-style: normal;
                }
                ...
                @font-face {
                  font-family: "Graphik";
                  src: url("<?php echo e(asset("assets/fonts/Graphik Regular.woff")); ?>") format("woff");
                  font-weight: 500;
                  font-style: normal;
                }
                ...
                @font-face {
                  font-family: "Graphik";
                  src: url("<?php echo e(asset("assets/fonts/Graphik Medium Regular.woff")); ?>") format("woff");
                  font-weight: 700;
                  font-style: normal;
                }
    ...
    async function loadSavedData() {
      ...
      if (appState.isEditMode && uid) {
          try {
              const response = await fetch(`<?php echo e(url("api/brief/get")); ?>?uid=${uid}`);
              if (response.ok) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/priokus/dsignloft/resources/views/index.blade.php ENDPATH**/ ?>